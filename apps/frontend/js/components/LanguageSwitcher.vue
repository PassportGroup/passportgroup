<template>
    <div class="relative z-50">
        ...
        >
            <img :src="`/static/flags/${$i18n.locale}.svg`" alt="flag" class="fill-current h-4 w-4">
            <span class="ml-1 text-sm text-white whitespace-no-wrap">{{ $i18n.locale.toUpperCase() }}</span>
                ...
                <li v-for="locale in locales" :key="locale.code">
                    <a href="#"
                       ...
                       @keydown.esc.exact="hideDropdown">
                        ...
                        <span class="ml-2 mr-2 capitalize">{{$t('general.'+locale.name.toString().toLowerCase())}}</span>
                    </a>
                </li>
            </ul>
        </transition>
