     ...
     <div class="flex items-center justify-center">
        <div class="pt-10 pb-10 sm:pt-24 sm:pb-36 lg:pt-40 lg:pb-56 text-center" style="">
            <svg width="96" height="96" fill="none" class="mx-auto mb-6 text-gray-900">
                ...
                <ellipse cx="37.5" cy="43.5" rx="4.5" ry="7.5" fill="currentColor"></ellipse><ellipse cx="58.5" cy="43.5" rx="4.5" ry="7.5" fill="currentColor"></ellipse>
            ...
            <p class="text-lg leading-5 font-medium text-gray-900 mb-3">
                {{ content }}
            </p>
        </div>
    </div>
